...
import 'package:klux_vip/services/cloudinary_service.dart';
          ...
          child: Column(
            ...
            children: [
              ...
              _buildSelector(
                ...
                onTap: () => _showSelectionDialog('Select Preferences', ['Quiet ride', 'Chatty', 'Music playing', 'No preference'], (val) => setState(() => _travelPreferences = val)),
                showChevron: true,
              ),
